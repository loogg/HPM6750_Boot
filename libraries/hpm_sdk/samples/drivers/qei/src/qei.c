...
#define BOARD_APP_QEI_BASE HPM_QEI2
#define BOARD_APP_QEI_IRQ  IRQn_QEI2
#define BOARD_APP_QEI_TRGM HPM_TRGM2
#define BOARD_APP_QEI_TRGM_QEI_A_SRC HPM_TRGM2_INPUT_SRC_TRGM2_P9
#define BOARD_APP_QEI_TRGM_QEI_B_SRC HPM_TRGM2_INPUT_SRC_TRGM2_P10
#define BOARD_APP_QEI_MOTOR_PHASE_COUNT_PER_REV (1000U)
#endif
