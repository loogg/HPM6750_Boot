...
void uf2_board_pwm_rgb_write(uint8_t const *rgb)
{
}
...
{
    uint32_t counter = 0;
    gpio_disable_pin_output(UF2_BOOTLOADER_PIN_GPIO_CTRL, UF2_BOOTLOADER_PIN_GPIO_INDEX, UF2_BOOTLOADER_PIN_GPIO_PIN);
