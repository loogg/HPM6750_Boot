 ...
 */
#define ADC16_ADC_CFG0_CONVERT_DURATION_MASK (0xFFFF000UL)
#define ADC16_ADC_CFG0_CONVERT_DURATION_SHIFT (12U)
#define ADC16_ADC_CFG0_CONVERT_DURATION_SET(x) (((uint32_t)(x) << ADC16_ADC_CFG0_CONVERT_DURATION_SHIFT) & ADC16_ADC_CFG0_CONVERT_DURATION_MASK)
#define ADC16_ADC_CFG0_CONVERT_DURATION_GET(x) (((uint32_t)(x) & ADC16_ADC_CFG0_CONVERT_DURATION_MASK) >> ADC16_ADC_CFG0_CONVERT_DURATION_SHIFT)
 ...
 */
#define ADC16_INT_STS_WDOG_MASK (0x3FFFU)
 ...
 * set if one chanel watch dog event triggered
 */
#define ADC16_INT_EN_WDOG_MASK (0x3FFFU)
 ...
 * TEMPSNS_EN (RW)
 *
 * set to enable temp senser
 */
#define ADC16_ADC16_CONFIG0_TEMPSNS_EN_MASK (0x2000000UL)
#define ADC16_ADC16_CONFIG0_TEMPSNS_EN_SHIFT (25U)
#define ADC16_ADC16_CONFIG0_TEMPSNS_EN_SET(x) (((uint32_t)(x) << ADC16_ADC16_CONFIG0_TEMPSNS_EN_SHIFT) & ADC16_ADC16_CONFIG0_TEMPSNS_EN_MASK)
#define ADC16_ADC16_CONFIG0_TEMPSNS_EN_GET(x) (((uint32_t)(x) & ADC16_ADC16_CONFIG0_TEMPSNS_EN_MASK) >> ADC16_ADC16_CONFIG0_TEMPSNS_EN_SHIFT)
