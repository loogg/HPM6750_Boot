...
static int enet_mac_init(ENET_Type *ptr, enet_mac_config_t *config, enet_inf_type_t inf_type, uint32_t mask_intr)
{
...
void enet_set_mask_interrupt(ENET_Type *ptr, uint32_t mask_intr)
{
    ptr->INTR_MASK |= mask_intr;
}
